...
> 原文：<https://segmentfault.com/a/1190000013565024>
> 对应题目：CSS 第 5 题 · 布局
> 抓取时间：2026-09-22
...
![图片描述](https://segmentfault.com/img/bV5ioR?w=619&h=362)

    公式转化:
    l = w * n + g * (n-1) -> l = w * n + g * n - g -> l + g = （w + g） * n

![图片描述](https://segmentfault.com/img/bV5ioO?w=610&h=375)
...
![图片描述](https://segmentfault.com/img/bV5im3?w=1144&h=776)
...
![图片描述](https://segmentfault.com/img/bV5im4?w=1162&h=790)
