...
> 原文：<https://segmentfault.com/a/1190000011358507>
> 对应题目：CSS 第 5 题 · 布局
> 抓取时间：2026-09-22
...
其实，我们可能经常在聊组件化，咋地咋地。但是，回过头来思考一下，如果你看到一张设计稿的时候，连布局都不清不楚，谈何组件化呢。所以，我们需要在分清楚组件之前，先来分清楚布局。废话说了这么多，只是想告诉你，布局这个东西真的很重要。本篇内容概括了布局的基础+基本的PC端布局+移动端适配等内容。如果你喜欢我的文章，欢迎评论，欢迎Star~。欢迎关注我的[github博客](<https://link.segmentfault.com/?enc=ssPIeumWb62h%2Fug378Pveg%3D%3D.bA%2FDHNtT3X4QEVVW0yckqMrCVS2L%2FYRVEVS110X%2FlW%2BMZ6O7JfTK1XiQB26zOZN0>)
...
谈及定位，我们就得从position属性说起。你能准确的说出position的属性值吗？相信你可以完美地说出这么六个属性值：static、relative、absolute、fixed、sticky和inherit。
  ...
  * sticky：(这是css3新增的属性值)粘性定位，官方的介绍比较简单，或许你不能理解。其实，它就相当于relative和fixed混合。最初会被当作是relative，相对于原来的位置进行偏移；一旦超过一定阈值之后，会被当成fixed定位，相对于视口进行定位。[demo地址](<https://link.segmentfault.com/?enc=twEfc4ea0QUkvvTTuCAlYQ%3D%3D.gWKwPdUUE%2FCfxEjJ8L33lQegV7FG3U8JbEJaRlgUdaz4uugxE5w2kDOsbQJEYKZF>)
...
![relative](https://segmentfault.com/img/remote/1460000011358512?w=208&h=216)![relative-offset](https://segmentfault.com/img/remote/1460000011358513?w=218&h=217)
...
单位只是一个来定义元素大小的相应参考。另一个概念，或许可以用房子来打一个比方，在早年每幢房子都会在房子的外围建一层栅栏，使得整一块地区可以看成房子+内部地块+栅栏+外围地块的模型。而在css中，每个元素也会有**盒子模型** 的概念。
...
![content-box](https://segmentfault.com/img/remote/1460000011358514)
...
![width-auto](https://segmentfault.com/img/remote/1460000011358515?w=454&h=222)
...
![float](https://segmentfault.com/img/remote/1460000011358516?w=206&h=214)
...
![浮动前](https://segmentfault.com/img/remote/1460000011358517?w=128&h=420)

之后我们将left的块设置成左浮动，如图：

![浮动后](https://segmentfault.com/img/remote/1460000011358518?w=112&h=252)
...
![两栏布局](https://segmentfault.com/img/remote/1460000011358519?w=1918&h=1006)
...
![两栏布局](https://segmentfault.com/img/remote/1460000011358520?w=956&h=615)
...
![first](https://segmentfault.com/img/remote/1460000011358521?w=452&h=215)
...
![image](https://segmentfault.com/img/remote/1460000011358522?w=457&h=217)
...
![bf-layout](https://segmentfault.com/img/remote/1460000011358523?w=454&h=212)
...
[demo地址](<https://link.segmentfault.com/?enc=vPdWLgT9hN5C40jEUInP6A%3D%3D.TTDxlFuO4PhFJtcAKD0v6%2FlI3xwToOJ7P2ASWxtI2IPNQinIsxhHgaOTR5EHHiRX>)

效果图：

![小于750px](https://segmentfault.com/img/remote/1460000011358524?w=640&h=372)  
![大于750px](https://segmentfault.com/img/remote/1460000011358525?w=953&h=306)

**flex弹性盒子**

其实移动端会经常使用到flex布局，因为在简单的页面适配方面，flex可以起到很好的拉伸的效果。我们先看几张图体会一下：

![flex盒子](https://segmentfault.com/img/remote/1460000007859559?w=320&h=499)  
![flex盒子](https://segmentfault.com/img/remote/1460000007859560?w=375&h=678)  
![flex盒子](https://segmentfault.com/img/remote/1460000007859561?w=700&h=581)

可以从图中看出，这个网页不管屏幕分辨率怎么发生变化，它的高度和位置都不变，而且里面的元素排布也没有发生变化，总是图标信息在左边和薪资状况在右边。

这就是很明显的，flex布局。flex可以在移动端适配比较简单的，元素比较单一的页面。

具体的flex布局内容，在这里不详细说明。[flex传送门](<https://link.segmentfault.com/?enc=8CVYFOgdGVDCeD5T7%2FL62w%3D%3D.MC05ZWgltHYs0dDqEjrIQrDLaCSMW6qWcyvmMPM2lsA9iVoQOWUssq3PbOqBVNHpgh4dk0ADBZJN8xqY7IgcSg%3D%3D>)

**rem适配**

rem可以说是移动端适配的一个神器。类似于手淘等界面，都是使用的rem进行的适配。这种界面有个特点就是页面元素的复杂度比较高，而使用flex进行布局会导致页面被拉伸，但是上下的高度却没有变化等问题。示例图：

![rem适配](https://segmentfault.com/img/remote/1460000007859566?w=320&h=673)![rem适配](https://segmentfault.com/img/remote/1460000007859567?w=365&h=671)

具体的讲解可以看这篇比较好的文章。[rem传送门](<https://link.segmentfault.com/?enc=3d2WbWqnv%2Bu0RrOtmrTTCQ%3D%3D.BuR6xiWxsujeq6ZowBrLP7O60j4w%2BkSGLQ9ocjd1amiUYCdMi6mcEwEM229Mrat3>)
...
> 最后，如果你对我写的有疑问，可以与我讨论。如果我写的有错误，欢迎指正。你喜欢我的博客，请给我关注Star~呦。大家一起总结一起进步。欢迎关注我的[github博客](<https://link.segmentfault.com/?enc=zJKUH5AU8x4QNrhBsxGdsA%3D%3D.89eJfIYU2g7JAA4wfy%2FzhMmhNDrdi58M0cc15Pgx%2BGLAcXKBTxd%2Bd0f5R2BewVaF>)
