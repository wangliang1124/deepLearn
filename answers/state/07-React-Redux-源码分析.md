...
> 原文：<https://juejin.cn/post/6844903498346135565>
> 对应题目：状态管理 第 7 题 · React-Redux
> 抓取时间：2026-09-22
> （经浏览器渲染后提取）
...
[欢迎访问我的个人博客](<https://link.juejin.cn?target=http%3A%2F%2Fblog.codingplayboy.com%2F2017%2F09%2F25%2Freact-redux%2F> "http://blog.codingplayboy.com/2017/09/25/react-redux/")
...
![react与redux应用结构](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2017/9/27/c091d5f0a4cdd18285266269dc5f3dfe~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)react与redux应用结构
...
![react-redux源码逻辑](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2017/9/27/8e24297aa0970d718ad238eac89b570b~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)react-redux源码逻辑
...
[源码](<https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Freactjs%2Freact-redux%2Fblob%2Fmaster%2Fsrc%2Futils%2FshallowEqual.js> "https://github.com/reactjs/react-redux/blob/master/src/utils/shallowEqual.js")
...
[源码](<https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Freactjs%2Freact-redux%2Fblob%2Fmaster%2Fsrc%2Fcomponents%2FconnectAdvanced.js> "https://github.com/reactjs/react-redux/blob/master/src/components/connectAdvanced.js")
...
_注：redux中的state通常指redux store的state而不是组件的state，另此处的props为传入组件wrapperComponent的props。_

[源码](<https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Freactjs%2Freact-redux%2Fblob%2Fmaster%2Fsrc%2Fconnect%2FselectorFactory.js> "https://github.com/reactjs/react-redux/blob/master/src/connect/selectorFactory.js")
...
通常容器组件props变更由store state变更推动，所以只有store state变更的情况较多，而且此处也正是使用Immutable时需要注意的地方： _不要在`mapStateToProps`方法内使用`toJS()`方法。_
...
_因为对比多次mapStateToProps返回的结果时是使用浅比较，所以不推荐使用Immutable.toJS()方法，其每次均返回一个新对象，对比将返回false，而如果使用Immutable且其内容未变更，则会返回true，可以减少不必要的重新渲染。_
...
## 参考阅读
  ...
  1. [React with redux](<https://link.juejin.cn?target=http%3A%2F%2Fredux.js.org%2Fdocs%2Fbasics%2FUsageWithReact.html> "http://redux.js.org/docs/basics/UsageWithReact.html")
  2. [Smart and Dumb Components](<https://link.juejin.cn?target=https%3A%2F%2Fmedium.com%2F%40dan_abramov%2Fsmart-and-dumb-components-7ca2f9a7c7d0> "https://medium.com/@dan_abramov/smart-and-dumb-components-7ca2f9a7c7d0")
  3. [React Redux Container Pattern](<https://link.juejin.cn?target=http%3A%2F%2Fwww.thegreatcodeadventure.com%2Fthe-react-plus-redux-container-pattern%2F> "http://www.thegreatcodeadventure.com/the-react-plus-redux-container-pattern/")\-
