...
> 原文：<https://juejin.cn/post/6844903815053852685>
> 对应题目：Reference 第 5 题 · 【面试篇】寒冬求职季之你必须要懂的原生 JS(上)
> 抓取时间：2026-09-22
> （经浏览器渲染后提取）
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/8/169fc27e0fdf4d09~tplv-t2oaga2asx-zoom-in-crop-mark:1512:0:0:0.awebp)
...
instanceof可以准确的判断复杂数据类型，但是不能正确判断基本数据类型。(正确判断数据类型请戳：[github.com/YvetteLau/B…](<https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FYvetteLau%2FBlog%2Fblob%2Fmaster%2FJS%2Fdata-type.js> "https://github.com/YvetteLau/Blog/blob/master/JS/data-type.js"))
...
如还不了解 iterator 接口或 for...of, 请先阅读ES6文档: [Iterator 和 for...of 循环](<https://link.juejin.cn?target=http%3A%2F%2Fes6.ruanyifeng.com%2F%23docs%2Fiterator> "http://es6.ruanyifeng.com/#docs/iterator")

更多细节请戳: [github.com/YvetteLau/B…](<https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FYvetteLau%2FBlog%2Fblob%2Fmaster%2FJS%2Ffor.js> "https://github.com/YvetteLau/Blog/blob/master/JS/for.js")
...
我们来分析一下: `[] == ![]` 是true还是false？
  ...
  1. 首先，我们需要知道 ! 优先级是高于 == (更多运算符优先级可查看: [运算符优先级](<https://link.juejin.cn?target=https%3A%2F%2Fdeveloper.mozilla.org%2Fzh-CN%2Fdocs%2FWeb%2FJavaScript%2FReference%2FOperators%2FOperator_Precedence> "https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/Operator_Precedence"))
...
如果this的知识点，您还不太懂，请戳: [嗨，你真的懂this吗？](<https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FYvetteLau%2FBlog%2Fissues%2F6> "https://github.com/YvetteLau/Blog/issues/6")
...
**题难不难？不难！继续挑战一下！难！知道难，就更要继续了！** ![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/8/169fc27e0fe8e59c~tplv-t2oaga2asx-zoom-in-crop-mark:1512:0:0:0.awebp)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/8/169fc27e0cf46ee9~tplv-t2oaga2asx-zoom-in-crop-mark:1512:0:0:0.awebp)
...
顺便说一句，ES6 中 `extends class` 的方式使用 babel 编译到ES5，使用的也是寄生组合式继承。
...
**看不下去了？别人的送分题会成为你的送命题** ![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/8/169fc27e10aadd22~tplv-t2oaga2asx-zoom-in-crop-mark:1512:0:0:0.awebp)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/8/169fc27e0dbdb30f~tplv-t2oaga2asx-zoom-in-crop-mark:1512:0:0:0.awebp)
...
promise的then实现，详见: [Promise源码实现](<https://juejin.cn/post/6844903796129136654> "https://juejin.cn/post/6844903796129136654")
...
如果想了解更多Promise的源码实现，可以参考我的另一篇文章：[Promise的源码实现（完美符合Promise/A+规范）](<https://juejin.cn/post/6844903796129136654#heading-24> "https://juejin.cn/post/6844903796129136654#heading-24")

* * *

### 31.如何实现 Promise.prototype.finally ?
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/8/169fc27e0dc3f463~tplv-t2oaga2asx-zoom-in-crop-mark:1512:0:0:0.awebp)

本文的写成耗费了非常多的时间，在这个过程中，我也学习到了很多知识，谢谢各位小伙伴愿意花费宝贵的时间阅读本文，如果本文给了您一点帮助或者是启发，请不要吝啬你的赞和Star，您的肯定是我前进的最大动力。[github.com/YvetteLau/B…](<https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FYvetteLau%2FBlog> "https://github.com/YvetteLau/Blog")
...
> 参考文章:
  ...
  1. [www.ibm.com/developerwo…](<https://link.juejin.cn?target=https%3A%2F%2Fwww.ibm.com%2Fdeveloperworks%2Fcn%2Fweb%2F1306_jiangjj_jsinstanceof%2Findex.html> "https://www.ibm.com/developerworks/cn/web/1306_jiangjj_jsinstanceof/index.html")
  2. [juejin.cn/post/684490…](<https://juejin.cn/post/6844903798784131079#heading-0> "https://juejin.cn/post/6844903798784131079#heading-0")
  3. 选用了面试之道上的部分面试题
  4. 选用了木易杨说文中提及的部分面试题: [juejin.cn/post/684490…](<https://juejin.cn/post/6844903695411314696> "https://juejin.cn/post/6844903695411314696")
  5. **特别说明** : `0.1 + 0.2 !== 0.3` 此题答案大量使用了此篇文章的图文: [juejin.cn/post/684490…](<https://juejin.cn/post/6844903680362151950> "https://juejin.cn/post/6844903680362151950")
  6. 选用了朋友面试大厂时遇到的一些面试题
  7. 《你不知道的JavaSctipt》
  8. 《JavaScript高级程序设计》
  9. [github.com/hanzichi/un…](<https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fhanzichi%2Funderscore-analysis%2Fissues%2F20> "https://github.com/hanzichi/underscore-analysis/issues/20")

### 关注“小姐姐”的公众号

![掘金使用](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/3/2/17098f029446a784~tplv-t2oaga2asx-zoom-in-crop-mark:1512:0:0:0.awebp)
